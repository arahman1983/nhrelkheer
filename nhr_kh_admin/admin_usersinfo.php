...
//
class cadmin_users extends cTable {
	var $id;
	var $userName;
	var $password;
	var $userLevel;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('admin_users', 'admin_users', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// userName
		$this->userName = new cField('admin_users', 'admin_users', 'x_userName', 'userName', '`userName`', '`userName`', 200, -1, FALSE, '`userName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['userName'] = &$this->userName;

		// password
		$this->password = new cField('admin_users', 'admin_users', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		$this->fields['password'] = &$this->password;

		// userLevel
		$this->userLevel = new cField('admin_users', 'admin_users', 'x_userLevel', 'userLevel', '`userLevel`', '`userLevel`', 3, -1, FALSE, '`userLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->userLevel->OptionCount = 2;
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`admin_users`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("admin_usersview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("admin_usersview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "admin_usersadd.php?" . $this->UrlParm($parm);
		else
			$url = "admin_usersadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("admin_usersedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("admin_usersadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("admin_usersdelete.php", $this->UrlParm());
	}
