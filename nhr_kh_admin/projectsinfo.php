...
class cprojects extends cTable {
	...
	function __construct() {
		...
		// project_brief
		$this->project_brief = new cField('projects', 'projects', 'x_project_brief', 'project_brief', '`project_brief`', '`project_brief`', 201, -1, FALSE, '`project_brief`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['project_brief'] = &$this->project_brief;

		// project_details
		$this->project_details = new cField('projects', 'projects', 'x_project_details', 'project_details', '`project_details`', '`project_details`', 201, -1, FALSE, '`project_details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['project_details'] = &$this->project_details;
		...
		// project_keywrds
		$this->project_keywrds = new cField('projects', 'projects', 'x_project_keywrds', 'project_keywrds', '`project_keywrds`', '`project_keywrds`', 201, -1, FALSE, '`project_keywrds`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['project_keywrds'] = &$this->project_keywrds;
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->project_brief->EditValue = $this->project_brief->CurrentValue;
		...
		$this->project_details->EditValue = $this->project_details->CurrentValue;
		...
		$this->project_keywrds->EditValue = $this->project_keywrds->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->project_brief->Exportable) $Doc->ExportCaption($this->project_brief);
					if ($this->project_details->Exportable) $Doc->ExportCaption($this->project_details);
					if ($this->project_pic->Exportable) $Doc->ExportCaption($this->project_pic);
					if ($this->project_keywrds->Exportable) $Doc->ExportCaption($this->project_keywrds);
				} else {
					if ($this->id->Exportable) $Doc->ExportCaption($this->id);
					if ($this->project_title->Exportable) $Doc->ExportCaption($this->project_title);
					if ($this->project_pic->Exportable) $Doc->ExportCaption($this->project_pic);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->project_brief->Exportable) $Doc->ExportField($this->project_brief);
						if ($this->project_details->Exportable) $Doc->ExportField($this->project_details);
						if ($this->project_pic->Exportable) $Doc->ExportField($this->project_pic);
						if ($this->project_keywrds->Exportable) $Doc->ExportField($this->project_keywrds);
					} else {
						if ($this->id->Exportable) $Doc->ExportField($this->id);
						if ($this->project_title->Exportable) $Doc->ExportField($this->project_title);
						if ($this->project_pic->Exportable) $Doc->ExportField($this->project_pic);
