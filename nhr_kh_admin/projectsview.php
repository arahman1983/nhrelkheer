...
<?php if ($projects->project_brief->Visible) { // project_brief ?>
	<tr id="r_project_brief">
		<td><span id="elh_projects_project_brief"><?php echo $projects->project_brief->FldCaption() ?></span></td>
		<td data-name="project_brief"<?php echo $projects->project_brief->CellAttributes() ?>>
<span id="el_projects_project_brief">
<span<?php echo $projects->project_brief->ViewAttributes() ?>>
<?php echo $projects->project_brief->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($projects->project_details->Visible) { // project_details ?>
	<tr id="r_project_details">
		<td><span id="elh_projects_project_details"><?php echo $projects->project_details->FldCaption() ?></span></td>
		<td data-name="project_details"<?php echo $projects->project_details->CellAttributes() ?>>
<span id="el_projects_project_details">
<span<?php echo $projects->project_details->ViewAttributes() ?>>
<?php echo $projects->project_details->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($projects->project_keywrds->Visible) { // project_keywrds ?>
	<tr id="r_project_keywrds">
		<td><span id="elh_projects_project_keywrds"><?php echo $projects->project_keywrds->FldCaption() ?></span></td>
		<td data-name="project_keywrds"<?php echo $projects->project_keywrds->CellAttributes() ?>>
<span id="el_projects_project_keywrds">
<span<?php echo $projects->project_keywrds->ViewAttributes() ?>>
<?php echo $projects->project_keywrds->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
