...
<?php if ($news->brief->Visible) { // brief ?>
	<tr id="r_brief">
		<td><span id="elh_news_brief"><?php echo $news->brief->FldCaption() ?></span></td>
		<td data-name="brief"<?php echo $news->brief->CellAttributes() ?>>
<span id="el_news_brief">
<span<?php echo $news->brief->ViewAttributes() ?>>
<?php echo $news->brief->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($news->details->Visible) { // details ?>
	<tr id="r_details">
		...
		<td data-name="details"<?php echo $news->details->CellAttributes() ?>>
...
<?php if ($news->pic->Visible) { // pic ?>
	<tr id="r_pic">
		<td><span id="elh_news_pic"><?php echo $news->pic->FldCaption() ?></span></td>
		<td data-name="pic"<?php echo $news->pic->CellAttributes() ?>>
<span id="el_news_pic">
<span>
<?php echo ew_GetFileViewTag($news->pic, $news->pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($news->key_wrds->Visible) { // key_wrds ?>
	<tr id="r_key_wrds">
		<td><span id="elh_news_key_wrds"><?php echo $news->key_wrds->FldCaption() ?></span></td>
		<td data-name="key_wrds"<?php echo $news->key_wrds->CellAttributes() ?>>
<span id="el_news_key_wrds">
<span<?php echo $news->key_wrds->ViewAttributes() ?>>
<?php echo $news->key_wrds->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
