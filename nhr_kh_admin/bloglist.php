...
<?php
	...
	if ($blog->CurrentAction == "" && $blog_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$blog_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<?php if ($blog->id->Visible) { // id ?>
	<?php if ($blog->SortUrl($blog->id) == "") { ?>
		<th data-name="id"><div id="elh_blog_id" class="blog_id"><div class="ewTableHeaderCaption"><?php echo $blog->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $blog->SortUrl($blog->id) ?>',1);"><div id="elh_blog_id" class="blog_id">
...
<?php if ($blog->title->Visible) { // title ?>
	<?php if ($blog->SortUrl($blog->title) == "") { ?>
		<th data-name="title"><div id="elh_blog_title" class="blog_title"><div class="ewTableHeaderCaption"><?php echo $blog->title->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="title"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $blog->SortUrl($blog->title) ?>',1);"><div id="elh_blog_title" class="blog_title">
