...
<?php if ($branches->branch_name->Visible) { // branch_name ?>
		<th><span id="elh_branches_branch_name" class="branches_branch_name"><?php echo $branches->branch_name->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $branches_delete->RowCnt ?>_branches_id" class="branches_id">
...
<?php } ?>
<?php if ($branches->branch_name->Visible) { // branch_name ?>
		<td<?php echo $branches->branch_name->CellAttributes() ?>>
<span id="el<?php echo $branches_delete->RowCnt ?>_branches_branch_name" class="branches_branch_name">
