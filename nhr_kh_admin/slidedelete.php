...
fslidedelete.ValidateRequired = true;
<?php } else { ?>
fslidedelete.ValidateRequired = false; 
<?php } ?>
...
if ($slide_delete->Recordset = $slide_delete->LoadRecordset())
	$slide_deleteTotalRecs = $slide_delete->Recordset->RecordCount(); // Get record count
if ($slide_deleteTotalRecs <= 0) { // No record found, exit
	if ($slide_delete->Recordset)
...
<?php if ($slide->id->Visible) { // id ?>
		<th><span id="elh_slide_id" class="slide_id"><?php echo $slide->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($slide->slink->Visible) { // slink ?>
		<th><span id="elh_slide_slink" class="slide_slink"><?php echo $slide->slink->FldCaption() ?></span></th>
<?php } ?>
<?php if ($slide->pic->Visible) { // pic ?>
		<th><span id="elh_slide_pic" class="slide_pic"><?php echo $slide->pic->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $slide_delete->RowCnt ?>_slide_id" class="slide_id">
...
<?php } ?>
<?php if ($slide->slink->Visible) { // slink ?>
		<td<?php echo $slide->slink->CellAttributes() ?>>
<span id="el<?php echo $slide_delete->RowCnt ?>_slide_slink" class="slide_slink">
...
<?php } ?>
<?php if ($slide->pic->Visible) { // pic ?>
		<td<?php echo $slide->pic->CellAttributes() ?>>
<span id="el<?php echo $slide_delete->RowCnt ?>_slide_pic" class="slide_pic">
<span>
