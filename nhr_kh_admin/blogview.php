...
<?php if ($blog->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_blog_id"><?php echo $blog->id->FldCaption() ?></span></td>
...
<?php if ($blog->title->Visible) { // title ?>
	<tr id="r_title">
		<td><span id="elh_blog_title"><?php echo $blog->title->FldCaption() ?></span></td>
...
<?php if ($blog->breif->Visible) { // breif ?>
	<tr id="r_breif">
		<td><span id="elh_blog_breif"><?php echo $blog->breif->FldCaption() ?></span></td>
		<td data-name="breif"<?php echo $blog->breif->CellAttributes() ?>>
<span id="el_blog_breif">
<span<?php echo $blog->breif->ViewAttributes() ?>>
<?php echo $blog->breif->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog->details->Visible) { // details ?>
	<tr id="r_details">
		<td><span id="elh_blog_details"><?php echo $blog->details->FldCaption() ?></span></td>
		<td data-name="details"<?php echo $blog->details->CellAttributes() ?>>
<span id="el_blog_details">
<span<?php echo $blog->details->ViewAttributes() ?>>
<?php echo $blog->details->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($blog->pic->Visible) { // pic ?>
	<tr id="r_pic">
		<td><span id="elh_blog_pic"><?php echo $blog->pic->FldCaption() ?></span></td>
		<td data-name="pic"<?php echo $blog->pic->CellAttributes() ?>>
<span id="el_blog_pic">
<span>
<?php echo ew_GetFileViewTag($blog->pic, $blog->pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($blog->key_wrds->Visible) { // key_wrds ?>
	<tr id="r_key_wrds">
		<td><span id="elh_blog_key_wrds"><?php echo $blog->key_wrds->FldCaption() ?></span></td>
		<td data-name="key_wrds"<?php echo $blog->key_wrds->CellAttributes() ?>>
<span id="el_blog_key_wrds">
<span<?php echo $blog->key_wrds->ViewAttributes() ?>>
<?php echo $blog->key_wrds->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
