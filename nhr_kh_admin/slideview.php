...
fslideview.ValidateRequired = true;
<?php } else { ?>
fslideview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($slide->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_slide_id"><?php echo $slide->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $slide->id->CellAttributes() ?>>
<span id="el_slide_id">
<span<?php echo $slide->id->ViewAttributes() ?>>
<?php echo $slide->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($slide->brief->Visible) { // brief ?>
	<tr id="r_brief">
		<td><span id="elh_slide_brief"><?php echo $slide->brief->FldCaption() ?></span></td>
		<td data-name="brief"<?php echo $slide->brief->CellAttributes() ?>>
<span id="el_slide_brief">
<span<?php echo $slide->brief->ViewAttributes() ?>>
<?php echo $slide->brief->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($slide->pic->Visible) { // pic ?>
	<tr id="r_pic">
		<td><span id="elh_slide_pic"><?php echo $slide->pic->FldCaption() ?></span></td>
		<td data-name="pic"<?php echo $slide->pic->CellAttributes() ?>>
<span id="el_slide_pic">
<span>
<?php echo ew_GetFileViewTag($slide->pic, $slide->pic->ViewValue) ?>
</span>
</span>
</td>
	</tr>
