...
$news_pic_blobview = NULL; // Initialize page object first

class cnews_pic_blobview extends cnews {
	...
	// Page object name
	var $PageObjName = 'news_pic_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'news');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('news', 'x_pic');
...
// Create page object
if (!isset($news_pic_blobview)) $news_pic_blobview = new cnews_pic_blobview();

// Page init
$news_pic_blobview->Page_Init();

// Page main
$news_pic_blobview->Page_Main();
?>
<?php
$news_pic_blobview->Page_Terminate();
?>
