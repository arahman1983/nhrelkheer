...
<?php if ($news->id->Visible) { // id ?>
		<th><span id="elh_news_id" class="news_id"><?php echo $news->id->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($news->pic->Visible) { // pic ?>
		<th><span id="elh_news_pic" class="news_pic"><?php echo $news->pic->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $news_delete->RowCnt ?>_news_id" class="news_id">
...
<?php } ?>
<?php if ($news->pic->Visible) { // pic ?>
		<td<?php echo $news->pic->CellAttributes() ?>>
<span id="el<?php echo $news_delete->RowCnt ?>_news_pic" class="news_pic">
<span>
