...
$photo_albums_view = NULL; // Initialize page object first

class cphoto_albums_view extends cphoto_albums {
	...
	// Page object name
	var $PageObjName = 'photo_albums_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "photo_albumslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "photo_albumslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "photo_albumslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($photo_albums_view)) $photo_albums_view = new cphoto_albums_view();

// Page init
$photo_albums_view->Page_Init();

// Page main
$photo_albums_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$photo_albums_view->Page_Render();
?>
...
var CurrentForm = fphoto_albumsview = new ew_Form("fphoto_albumsview", "view");

// Form_CustomValidate event
fphoto_albumsview.Form_CustomValidate = 
...
fphoto_albumsview.ValidateRequired = true;
<?php } else { ?>
fphoto_albumsview.ValidateRequired = false; 
<?php } ?>
...
<?php $photo_albums_view->ExportOptions->Render("body") ?>
<?php
	foreach ($photo_albums_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $photo_albums_view->ShowPageHeader(); ?>
<?php
$photo_albums_view->ShowMessage();
?>
<form name="fphoto_albumsview" id="fphoto_albumsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($photo_albums_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $photo_albums_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="photo_albums">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($photo_albums->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_photo_albums_id"><?php echo $photo_albums->id->FldCaption() ?></span></td>
...
<?php echo $photo_albums->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($photo_albums->album_title->Visible) { // album_title ?>
	<tr id="r_album_title">
		<td><span id="elh_photo_albums_album_title"><?php echo $photo_albums->album_title->FldCaption() ?></span></td>
...
<?php echo $photo_albums->album_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($photo_albums->album_Imge->Visible) { // album_Imge ?>
	<tr id="r_album_Imge">
		<td><span id="elh_photo_albums_album_Imge"><?php echo $photo_albums->album_Imge->FldCaption() ?></span></td>
		<td data-name="album_Imge"<?php echo $photo_albums->album_Imge->CellAttributes() ?>>
<span id="el_photo_albums_album_Imge">
<span>
<?php echo ew_GetFileViewTag($photo_albums->album_Imge, $photo_albums->album_Imge->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fphoto_albumsview.Init();
</script>
<?php
$photo_albums_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$photo_albums_view->Page_Terminate();
?>
