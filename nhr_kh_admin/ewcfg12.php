...
define("EW_PROJECT_NAME", "nhr_kh_admin", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{2740043E-02B0-4E15-B10B-02037850EEC7}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'fcnMqvPZr1IvgoAz', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/nhr_kh_admin.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "nhrkheir", "qs" => "`", "qe" => "`");
...
// Security
define("EW_ADMIN_USER_NAME", "nhr@admin", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "kh@Nahr18", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`admin_users`", TRUE);
