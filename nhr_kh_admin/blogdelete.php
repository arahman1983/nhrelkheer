...
<?php if ($blog->id->Visible) { // id ?>
		<th><span id="elh_blog_id" class="blog_id"><?php echo $blog->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->title->Visible) { // title ?>
		<th><span id="elh_blog_title" class="blog_title"><?php echo $blog->title->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
