...
$photos_images_blobview = NULL; // Initialize page object first

class cphotos_images_blobview extends cphotos {
	...
	// Page object name
	var $PageObjName = 'photos_images_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'photos');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('photos', 'x_images');
...
// Create page object
if (!isset($photos_images_blobview)) $photos_images_blobview = new cphotos_images_blobview();

// Page init
$photos_images_blobview->Page_Init();

// Page main
$photos_images_blobview->Page_Main();
?>
<?php
$photos_images_blobview->Page_Terminate();
?>
