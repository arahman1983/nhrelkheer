...
class cslide_add extends cslide {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "slideview.php")
	...
	function LoadDefaultValues() {
		...
		$this->slink->CurrentValue = NULL;
		$this->slink->OldValue = $this->slink->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// slink
		$this->slink->SetDbValueDef($rsnew, $this->slink->CurrentValue, NULL, FALSE);
...
fslideadd.ValidateRequired = true;
<?php } else { ?>
fslideadd.ValidateRequired = false; 
<?php } ?>
