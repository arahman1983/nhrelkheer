...
class cprojects_list extends cprojects {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->project_brief->AdvancedSearch->ToJSON(), ","); // Field project_brief
		$sFilterList = ew_Concat($sFilterList, $this->project_details->AdvancedSearch->ToJSON(), ","); // Field project_details
		$sFilterList = ew_Concat($sFilterList, $this->project_pic->AdvancedSearch->ToJSON(), ","); // Field project_pic
		$sFilterList = ew_Concat($sFilterList, $this->project_keywrds->AdvancedSearch->ToJSON(), ","); // Field project_keywrds
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field project_brief
		$this->project_brief->AdvancedSearch->SearchValue = @$filter["x_project_brief"];
		$this->project_brief->AdvancedSearch->SearchOperator = @$filter["z_project_brief"];
		$this->project_brief->AdvancedSearch->SearchCondition = @$filter["v_project_brief"];
		$this->project_brief->AdvancedSearch->SearchValue2 = @$filter["y_project_brief"];
		$this->project_brief->AdvancedSearch->SearchOperator2 = @$filter["w_project_brief"];
		$this->project_brief->AdvancedSearch->Save();

		// Field project_details
		$this->project_details->AdvancedSearch->SearchValue = @$filter["x_project_details"];
		$this->project_details->AdvancedSearch->SearchOperator = @$filter["z_project_details"];
		$this->project_details->AdvancedSearch->SearchCondition = @$filter["v_project_details"];
		$this->project_details->AdvancedSearch->SearchValue2 = @$filter["y_project_details"];
		$this->project_details->AdvancedSearch->SearchOperator2 = @$filter["w_project_details"];
		$this->project_details->AdvancedSearch->Save();
		...
		// Field project_keywrds
		$this->project_keywrds->AdvancedSearch->SearchValue = @$filter["x_project_keywrds"];
		$this->project_keywrds->AdvancedSearch->SearchOperator = @$filter["z_project_keywrds"];
		$this->project_keywrds->AdvancedSearch->SearchCondition = @$filter["v_project_keywrds"];
		$this->project_keywrds->AdvancedSearch->SearchValue2 = @$filter["y_project_keywrds"];
		$this->project_keywrds->AdvancedSearch->SearchOperator2 = @$filter["w_project_keywrds"];
		$this->project_keywrds->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->project_brief, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->project_details, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->project_pic, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->project_keywrds, $arKeywords, $type);
		return $sWhere;
	}
