...
$slide_pic_blobview = NULL; // Initialize page object first

class cslide_pic_blobview extends cslide {
	...
	// Page object name
	var $PageObjName = 'slide_pic_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'slide');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('slide', 'x_pic');
...
// Create page object
if (!isset($slide_pic_blobview)) $slide_pic_blobview = new cslide_pic_blobview();

// Page init
$slide_pic_blobview->Page_Init();

// Page main
$slide_pic_blobview->Page_Main();
?>
<?php
$slide_pic_blobview->Page_Terminate();
?>
