...
var CurrentForm = fphotosdelete = new ew_Form("fphotosdelete", "delete");
...
fphotosdelete.Lists["x_album_name"] = {"LinkField":"x_album_title","Ajax":true,"AutoFill":false,"DisplayFields":["x_album_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
?>
<form name="fphotosdelete" id="fphotosdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($photos_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $photos_delete->Token ?>">
<?php } ?>
...
<?php if ($photos->id->Visible) { // id ?>
		<th><span id="elh_photos_id" class="photos_id"><?php echo $photos->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($photos->title->Visible) { // title ?>
		<th><span id="elh_photos_title" class="photos_title"><?php echo $photos->title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($photos->album_name->Visible) { // album_name ?>
		<th><span id="elh_photos_album_name" class="photos_album_name"><?php echo $photos->album_name->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($photos->id->Visible) { // id ?>
		<td<?php echo $photos->id->CellAttributes() ?>>
<span id="el<?php echo $photos_delete->RowCnt ?>_photos_id" class="photos_id">
...
<span id="el<?php echo $photos_delete->RowCnt ?>_photos_title" class="photos_title">
...
<?php } ?>
<?php if ($photos->album_name->Visible) { // album_name ?>
		<td<?php echo $photos->album_name->CellAttributes() ?>>
<span id="el<?php echo $photos_delete->RowCnt ?>_photos_album_name" class="photos_album_name">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $photos_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fphotosdelete.Init();
