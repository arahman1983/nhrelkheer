...
class cslide_list extends cslide {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->brief->AdvancedSearch->ToJSON(), ","); // Field brief
		$sFilterList = ew_Concat($sFilterList, $this->slink->AdvancedSearch->ToJSON(), ","); // Field slink
	...
	function RestoreFilterList() {
		...
		// Field brief
		$this->brief->AdvancedSearch->SearchValue = @$filter["x_brief"];
		$this->brief->AdvancedSearch->SearchOperator = @$filter["z_brief"];
		$this->brief->AdvancedSearch->SearchCondition = @$filter["v_brief"];
		$this->brief->AdvancedSearch->SearchValue2 = @$filter["y_brief"];
		$this->brief->AdvancedSearch->SearchOperator2 = @$filter["w_brief"];
		$this->brief->AdvancedSearch->Save();

		// Field slink
		$this->slink->AdvancedSearch->SearchValue = @$filter["x_slink"];
		$this->slink->AdvancedSearch->SearchOperator = @$filter["z_slink"];
		$this->slink->AdvancedSearch->SearchCondition = @$filter["v_slink"];
		$this->slink->AdvancedSearch->SearchValue2 = @$filter["y_slink"];
		$this->slink->AdvancedSearch->SearchOperator2 = @$filter["w_slink"];
		$this->slink->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->brief, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->slink, $arKeywords, $type);
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->slink); // slink
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fslidelistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
	...
	function RenderRow() {
		...
		$this->pic->ViewCustomAttributes = "";
			...
			if ($this->pic->UseColorbox) {
				...
				$this->pic->LinkAttrs["data-rel"] = "slide_x" . $this->RowCnt . "_pic";
...
<?php
	...
	if ($slide->CurrentAction == "" && $slide_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$slide_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<form name="fslidelistsrch" id="fslidelistsrch" class="form-inline ewForm" action="<?php echo ew_CurrentPage() ?>">
...
<?php if ($slide->id->Visible) { // id ?>
	<?php if ($slide->SortUrl($slide->id) == "") { ?>
		<th data-name="id"><div id="elh_slide_id" class="slide_id"><div class="ewTableHeaderCaption"><?php echo $slide->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->id) ?>',1);"><div id="elh_slide_id" class="slide_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($slide->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($slide->slink->Visible) { // slink ?>
	<?php if ($slide->SortUrl($slide->slink) == "") { ?>
		<th data-name="slink"><div id="elh_slide_slink" class="slide_slink"><div class="ewTableHeaderCaption"><?php echo $slide->slink->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="slink"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->slink) ?>',1);"><div id="elh_slide_slink" class="slide_slink">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->slink->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($slide->slink->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->slink->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($slide->pic->Visible) { // pic ?>
	<?php if ($slide->SortUrl($slide->pic) == "") { ?>
		<th data-name="pic"><div id="elh_slide_pic" class="slide_pic"><div class="ewTableHeaderCaption"><?php echo $slide->pic->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="pic"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->pic) ?>',1);"><div id="elh_slide_pic" class="slide_pic">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->pic->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($slide->pic->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->pic->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($slide->id->Visible) { // id ?>
		<td data-name="id"<?php echo $slide->id->CellAttributes() ?>>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_id" class="slide_id">
<span<?php echo $slide->id->ViewAttributes() ?>>
<?php echo $slide->id->ListViewValue() ?></span>
</span>
<a id="<?php echo $slide_list->PageObjName . "_row_" . $slide_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($slide->slink->Visible) { // slink ?>
		<td data-name="slink"<?php echo $slide->slink->CellAttributes() ?>>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_slink" class="slide_slink">
<span<?php echo $slide->slink->ViewAttributes() ?>>
<?php echo $slide->slink->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($slide->pic->Visible) { // pic ?>
		<td data-name="pic"<?php echo $slide->pic->CellAttributes() ?>>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_pic" class="slide_pic">
<span>
<?php echo ew_GetFileViewTag($slide->pic, $slide->pic->ListViewValue()) ?>
</span>
</span>
</td>
	<?php } ?>
...
<?php if (!isset($slide_list->Pager)) $slide_list->Pager = new cPrevNextPager($slide_list->StartRec, $slide_list->DisplayRecs, $slide_list->TotalRecs) ?>
