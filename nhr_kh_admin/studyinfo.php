...
//
// Table class for study
//
class cstudy extends cTable {
	var $id;
	var $title;
	var $breif;
	var $details;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('study', 'study', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('study', 'study', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['title'] = &$this->title;

		// breif
		$this->breif = new cField('study', 'study', 'x_breif', 'breif', '`breif`', '`breif`', 201, -1, FALSE, '`breif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['breif'] = &$this->breif;

		// details
		$this->details = new cField('study', 'study', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['details'] = &$this->details;

		// pic
		$this->pic = new cField('study', 'study', 'x_pic', 'pic', '`pic`', '`pic`', 200, -1, TRUE, '`pic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->fields['pic'] = &$this->pic;

		// key_wrds
		$this->key_wrds = new cField('study', 'study', 'x_key_wrds', 'key_wrds', '`key_wrds`', '`key_wrds`', 201, -1, FALSE, '`key_wrds`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`study`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("studyview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("studyview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "studyadd.php?" . $this->UrlParm($parm);
		else
			$url = "studyadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("studyedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("studyadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("studydelete.php", $this->UrlParm());
	}
