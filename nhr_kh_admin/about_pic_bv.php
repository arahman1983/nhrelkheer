...
$about_pic_blobview = NULL; // Initialize page object first

class cabout_pic_blobview extends cabout {
	...
	// Page object name
	var $PageObjName = 'about_pic_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'about');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('about', 'x_pic');
...
// Create page object
if (!isset($about_pic_blobview)) $about_pic_blobview = new cabout_pic_blobview();

// Page init
$about_pic_blobview->Page_Init();

// Page main
$about_pic_blobview->Page_Main();
?>
<?php
$about_pic_blobview->Page_Terminate();
?>
