...
class cblog extends cTable {
	...
	function __construct() {
		...
		// breif
		$this->breif = new cField('blog', 'blog', 'x_breif', 'breif', '`breif`', '`breif`', 201, -1, FALSE, '`breif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['breif'] = &$this->breif;

		// details
		$this->details = new cField('blog', 'blog', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->fields['details'] = &$this->details;

		// pic
		$this->pic = new cField('blog', 'blog', 'x_pic', 'pic', '`pic`', '`pic`', 200, -1, TRUE, '`pic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->fields['pic'] = &$this->pic;

		// key_wrds
		$this->key_wrds = new cField('blog', 'blog', 'x_key_wrds', 'key_wrds', '`key_wrds`', '`key_wrds`', 201, -1, FALSE, '`key_wrds`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
