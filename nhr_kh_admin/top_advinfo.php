...
//
// Table class for top_adv
//
class ctop_adv extends cTable {
	var $id;
	var $title;
	var $pic;
	var $link;
	...
	function __construct() {
		...
		$this->TableVar = 'top_adv';
		$this->TableName = 'top_adv';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`top_adv`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('top_adv', 'top_adv', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('top_adv', 'top_adv', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['title'] = &$this->title;

		// pic
		$this->pic = new cField('top_adv', 'top_adv', 'x_pic', 'pic', '`pic`', '`pic`', 200, -1, TRUE, '`pic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->fields['pic'] = &$this->pic;

		// link
		$this->link = new cField('top_adv', 'top_adv', 'x_link', 'link', '`link`', '`link`', 200, -1, FALSE, '`link`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`top_adv`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("top_advview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("top_advview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "top_advadd.php?" . $this->UrlParm($parm);
		else
			$url = "top_advadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("top_advedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("top_advadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("top_advdelete.php", $this->UrlParm());
	}
