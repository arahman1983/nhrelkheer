	...
	function RenderRow() {
		...
		$this->pic->ViewCustomAttributes = "";
			...
			if ($this->pic->UseColorbox) {
				...
				$this->pic->LinkAttrs["data-rel"] = "news_x" . $this->RowCnt . "_pic";
...
<?php
	...
	if ($news->CurrentAction == "" && $news_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$news_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<?php if ($news->id->Visible) { // id ?>
	<?php if ($news->SortUrl($news->id) == "") { ?>
		<th data-name="id"><div id="elh_news_id" class="news_id"><div class="ewTableHeaderCaption"><?php echo $news->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->id) ?>',1);"><div id="elh_news_id" class="news_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($news->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<?php if ($news->pic->Visible) { // pic ?>
	<?php if ($news->SortUrl($news->pic) == "") { ?>
		<th data-name="pic"><div id="elh_news_pic" class="news_pic"><div class="ewTableHeaderCaption"><?php echo $news->pic->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="pic"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $news->SortUrl($news->pic) ?>',1);"><div id="elh_news_pic" class="news_pic">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $news->pic->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($news->pic->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($news->pic->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($news->id->Visible) { // id ?>
		<td data-name="id"<?php echo $news->id->CellAttributes() ?>>
<span id="el<?php echo $news_list->RowCnt ?>_news_id" class="news_id">
...
<?php echo $news->title->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($news->pic->Visible) { // pic ?>
		<td data-name="pic"<?php echo $news->pic->CellAttributes() ?>>
<span id="el<?php echo $news_list->RowCnt ?>_news_pic" class="news_pic">
<span>
<?php echo ew_GetFileViewTag($news->pic, $news->pic->ListViewValue()) ?>
</span>
</span>
</td>
	<?php } ?>
