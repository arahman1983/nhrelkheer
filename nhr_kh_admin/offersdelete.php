...
foffersdelete.Lists["x_project"] = {"LinkField":"x_project_title","Ajax":true,"AutoFill":false,"DisplayFields":["x_project_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($offers->offers_title->Visible) { // offers_title ?>
		<th><span id="elh_offers_offers_title" class="offers_offers_title"><?php echo $offers->offers_title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($offers->project->Visible) { // project ?>
		<th><span id="elh_offers_project" class="offers_project"><?php echo $offers->project->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($offers->offers_title->Visible) { // offers_title ?>
		<td<?php echo $offers->offers_title->CellAttributes() ?>>
<span id="el<?php echo $offers_delete->RowCnt ?>_offers_offers_title" class="offers_offers_title">
<span<?php echo $offers->offers_title->ViewAttributes() ?>>
<?php echo $offers->offers_title->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($offers->project->Visible) { // project ?>
		<td<?php echo $offers->project->CellAttributes() ?>>
<span id="el<?php echo $offers_delete->RowCnt ?>_offers_project" class="offers_project">
<span<?php echo $offers->project->ViewAttributes() ?>>
<?php echo $offers->project->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
