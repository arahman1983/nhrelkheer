...
$study_pic_blobview = NULL; // Initialize page object first

class cstudy_pic_blobview extends cstudy {
	...
	// Page object name
	var $PageObjName = 'study_pic_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'study');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('study', 'x_pic');
...
// Create page object
if (!isset($study_pic_blobview)) $study_pic_blobview = new cstudy_pic_blobview();

// Page init
$study_pic_blobview->Page_Init();

// Page main
$study_pic_blobview->Page_Main();
?>
<?php
$study_pic_blobview->Page_Terminate();
?>
