...
$blog_pic_blobview = NULL; // Initialize page object first

class cblog_pic_blobview extends cblog {
	...
	// Page object name
	var $PageObjName = 'blog_pic_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'blog');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('blog', 'x_pic');
...
// Create page object
if (!isset($blog_pic_blobview)) $blog_pic_blobview = new cblog_pic_blobview();

// Page init
$blog_pic_blobview->Page_Init();

// Page main
$blog_pic_blobview->Page_Main();
?>
<?php
$blog_pic_blobview->Page_Terminate();
?>
