...
$about_add = NULL; // Initialize page object first

class cabout_add extends cabout {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "aboutview.php")
...
// Create page object
if (!isset($about_add)) $about_add = new cabout_add();
...
var CurrentForm = faboutadd = new ew_Form("faboutadd", "add");

// Validate form
faboutadd.Validate = function() {
...
faboutadd.ValidateRequired = true;
<?php } else { ?>
faboutadd.ValidateRequired = false; 
<?php } ?>
...
<?php $about_add->ShowPageHeader(); ?>
<?php
$about_add->ShowMessage();
?>
<form name="faboutadd" id="faboutadd" class="<?php echo $about_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($about_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $about_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $about_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
</form>
<script type="text/javascript">
