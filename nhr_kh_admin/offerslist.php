...
class coffers_list extends coffers {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->offers_title->AdvancedSearch->ToJSON(), ","); // Field offers_title
		$sFilterList = ew_Concat($sFilterList, $this->offers_brief->AdvancedSearch->ToJSON(), ","); // Field offers_brief
		$sFilterList = ew_Concat($sFilterList, $this->offers_details->AdvancedSearch->ToJSON(), ","); // Field offers_details
		$sFilterList = ew_Concat($sFilterList, $this->offers_pic->AdvancedSearch->ToJSON(), ","); // Field offers_pic
		$sFilterList = ew_Concat($sFilterList, $this->project->AdvancedSearch->ToJSON(), ","); // Field project
		$sFilterList = ew_Concat($sFilterList, $this->offers_keywrds->AdvancedSearch->ToJSON(), ","); // Field offers_keywrds
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field offers_title
		$this->offers_title->AdvancedSearch->SearchValue = @$filter["x_offers_title"];
		$this->offers_title->AdvancedSearch->SearchOperator = @$filter["z_offers_title"];
		$this->offers_title->AdvancedSearch->SearchCondition = @$filter["v_offers_title"];
		$this->offers_title->AdvancedSearch->SearchValue2 = @$filter["y_offers_title"];
		$this->offers_title->AdvancedSearch->SearchOperator2 = @$filter["w_offers_title"];
		$this->offers_title->AdvancedSearch->Save();

		// Field offers_brief
		$this->offers_brief->AdvancedSearch->SearchValue = @$filter["x_offers_brief"];
		$this->offers_brief->AdvancedSearch->SearchOperator = @$filter["z_offers_brief"];
		$this->offers_brief->AdvancedSearch->SearchCondition = @$filter["v_offers_brief"];
		$this->offers_brief->AdvancedSearch->SearchValue2 = @$filter["y_offers_brief"];
		$this->offers_brief->AdvancedSearch->SearchOperator2 = @$filter["w_offers_brief"];
		$this->offers_brief->AdvancedSearch->Save();

		// Field offers_details
		$this->offers_details->AdvancedSearch->SearchValue = @$filter["x_offers_details"];
		$this->offers_details->AdvancedSearch->SearchOperator = @$filter["z_offers_details"];
		$this->offers_details->AdvancedSearch->SearchCondition = @$filter["v_offers_details"];
		$this->offers_details->AdvancedSearch->SearchValue2 = @$filter["y_offers_details"];
		$this->offers_details->AdvancedSearch->SearchOperator2 = @$filter["w_offers_details"];
		$this->offers_details->AdvancedSearch->Save();

		// Field offers_pic
		$this->offers_pic->AdvancedSearch->SearchValue = @$filter["x_offers_pic"];
		$this->offers_pic->AdvancedSearch->SearchOperator = @$filter["z_offers_pic"];
		$this->offers_pic->AdvancedSearch->SearchCondition = @$filter["v_offers_pic"];
		$this->offers_pic->AdvancedSearch->SearchValue2 = @$filter["y_offers_pic"];
		$this->offers_pic->AdvancedSearch->SearchOperator2 = @$filter["w_offers_pic"];
		$this->offers_pic->AdvancedSearch->Save();

		// Field project
		$this->project->AdvancedSearch->SearchValue = @$filter["x_project"];
		$this->project->AdvancedSearch->SearchOperator = @$filter["z_project"];
		$this->project->AdvancedSearch->SearchCondition = @$filter["v_project"];
		$this->project->AdvancedSearch->SearchValue2 = @$filter["y_project"];
		$this->project->AdvancedSearch->SearchOperator2 = @$filter["w_project"];
		$this->project->AdvancedSearch->Save();

		// Field offers_keywrds
		$this->offers_keywrds->AdvancedSearch->SearchValue = @$filter["x_offers_keywrds"];
		$this->offers_keywrds->AdvancedSearch->SearchOperator = @$filter["z_offers_keywrds"];
		$this->offers_keywrds->AdvancedSearch->SearchCondition = @$filter["v_offers_keywrds"];
		$this->offers_keywrds->AdvancedSearch->SearchValue2 = @$filter["y_offers_keywrds"];
		$this->offers_keywrds->AdvancedSearch->SearchOperator2 = @$filter["w_offers_keywrds"];
		$this->offers_keywrds->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $this->offers_title, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->offers_brief, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->offers_details, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->offers_pic, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->project, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->offers_keywrds, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->offers_title); // offers_title
			$this->UpdateSort($this->project); // project
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->setSessionOrderBy($sOrderBy);
				$this->id->setSort("");
				$this->offers_title->setSort("");
				$this->project->setSort("");
			}
...
fofferslist.Lists["x_project"] = {"LinkField":"x_project_title","Ajax":true,"AutoFill":false,"DisplayFields":["x_project_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
...
<?php if ($offers->offers_title->Visible) { // offers_title ?>
	<?php if ($offers->SortUrl($offers->offers_title) == "") { ?>
		<th data-name="offers_title"><div id="elh_offers_offers_title" class="offers_offers_title"><div class="ewTableHeaderCaption"><?php echo $offers->offers_title->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="offers_title"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $offers->SortUrl($offers->offers_title) ?>',1);"><div id="elh_offers_offers_title" class="offers_offers_title">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $offers->offers_title->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($offers->offers_title->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($offers->offers_title->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($offers->project->Visible) { // project ?>
	<?php if ($offers->SortUrl($offers->project) == "") { ?>
		<th data-name="project"><div id="elh_offers_project" class="offers_project"><div class="ewTableHeaderCaption"><?php echo $offers->project->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="project"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $offers->SortUrl($offers->project) ?>',1);"><div id="elh_offers_project" class="offers_project">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $offers->project->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($offers->project->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($offers->project->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $offers_list->RowCnt ?>_offers_offers_title" class="offers_offers_title">
...
<span id="el<?php echo $offers_list->RowCnt ?>_offers_project" class="offers_project">
